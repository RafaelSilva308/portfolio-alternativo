...
export const services = [
  {
    ...
    items: ["Aplicações web full stack", "Painéis administrativos", "Integrações e APIs", "Autenticação e assinaturas"],
  },
  {
    id: "landing-pages",
    title: "Landing Pages",
    ...
    items: ["Design responsivo", "Integração com WhatsApp", "Otimizadas para conversão", "Entrega rápida"],
  },
  {
    id: "automacao",
    ...
    items: ["Web scraping e coleta de dados", "Análise com modelos de IA", "Integração com Notion, Sheets e APIs", "Rotinas agendadas"],
  },
];
